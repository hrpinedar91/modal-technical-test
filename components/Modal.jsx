            ...
            <AlertDialogContent>
                <ScrollArea className="w-full h-full max-h-[80vh] pb-16 p-8 md:pb-8 relative">
                    <AlertDialogCancel className="bg-[#D9D9D9] w-[28px] h-[28px]  flex p-2 place-content-center rounded-full absolute top-4 right-8 cursor-pointer">
                        <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" class="lucide lucide-x"><path d="M18 6 6 18" /><path d="m6 6 12 12" /></svg>
                    </AlertDialogCancel>
                    ...
                    <form className="mt-4 md:mx-12">
                        ...
                        <p className="text-center mt-8 pb-8 md:pb-0 font-medium" style={{ textWrap: "balance" }} >Cuando se registra para recibir actualizaciones por correo electrónico, tiene la oportunidad de ganar un scooter eléctricoMinca 800W gratis por un valor de $3.990.000</p>
                    </form>
                </ScrollArea>
            </AlertDialogContent>
        </AlertDialog>
