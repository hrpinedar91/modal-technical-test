        ...
        <AlertDialog>
            ...
            <AlertDialogContent>
                <ScrollArea className="w-full p-8 h-full max-h-[80vh] relative">
                    ...
                    <Image src="/TRANSPARENTE-CON-SOMBRA-800w1.png" alt="scooter" width={393} height={251} className="mx-12" />
                    ...
                    <form className="mt-4 mx-12">
                        ...
                        <Button type="submit" className="w-full bg-black text-white mt-8 rounded-full p-2">Suscribir</Button>
